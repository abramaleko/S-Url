...
export default{
    components: {
        AuthenticatedLayout,Head,Link,CardStats
    },
   props: {
       url: Object,
   },
                ...
                <div class="flex mb-4 flex-nowrap">
                    ...
                    <div class="ml-2" >
                        <label for="green-toggle" class="relative inline-flex items-center mr-5 cursor-pointer">
                            <input type="checkbox" value="" id="green-toggle" class="sr-only peer" :checked="url.status" @click="updateStatus">
                            <div
                            ...
                            <span class="ml-3 text-base text-gray-600 md:text-lg dark:text-gray-300" v-text=" url.status ? 'Active' : 'Disabled'"
                            >
                            </span>
                        </label>
